...
# Clean RCARE-Forecast launcher for ZafNoo.
# Usage examples:
#   bash scripts/ZafNoo.sh
#   RUN_STAGE=numeric bash scripts/ZafNoo.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/ZafNoo.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/ZafNoo.sh
