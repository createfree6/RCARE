...
# Clean RCARE-Forecast launcher for exchange_rate.
# Usage examples:
#   bash scripts/exchange_rate.sh
#   RUN_STAGE=numeric bash scripts/exchange_rate.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/exchange_rate.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/exchange_rate.sh
