...
# Clean RCARE-Forecast launcher for AQWan.
# Usage examples:
#   bash scripts/AQWan.sh
#   RUN_STAGE=numeric bash scripts/AQWan.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/AQWan.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/AQWan.sh
