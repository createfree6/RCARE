...
# Clean RCARE-Forecast launcher for beijing_pm25.
# Usage examples:
#   bash scripts/beijing_pm25.sh
#   RUN_STAGE=numeric bash scripts/beijing_pm25.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/beijing_pm25.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/beijing_pm25.sh
