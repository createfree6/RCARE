...
# Clean RCARE-Forecast launcher for CzeLan.
# Usage examples:
#   bash scripts/CzeLan.sh
#   RUN_STAGE=numeric bash scripts/CzeLan.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/CzeLan.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/CzeLan.sh
