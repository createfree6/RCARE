...
# Clean RCARE-Forecast launcher for ETTh1.
# Usage examples:
#   bash scripts/ETTh1.sh
#   RUN_STAGE=numeric bash scripts/ETTh1.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/ETTh1.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/ETTh1.sh
