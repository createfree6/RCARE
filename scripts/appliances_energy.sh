...
# Clean RCARE-Forecast launcher for appliances_energy.
# Usage examples:
#   bash scripts/appliances_energy.sh
#   RUN_STAGE=numeric bash scripts/appliances_energy.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/appliances_energy.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/appliances_energy.sh
