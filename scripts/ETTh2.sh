...
# Clean RCARE-Forecast launcher for ETTh2.
# Usage examples:
#   bash scripts/ETTh2.sh
#   RUN_STAGE=numeric bash scripts/ETTh2.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/ETTh2.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/ETTh2.sh
...
TARGET="${TARGET:-OT}"
FEATURES="${FEATURES:-M}"
SPLIT_MODE="${SPLIT_MODE:-ett_standard}"
FREQ="${FREQ:-h}"
