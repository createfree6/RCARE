...
# Clean RCARE-Forecast launcher for AQShunyi.
# Usage examples:
#   bash scripts/AQShunyi.sh
#   RUN_STAGE=numeric bash scripts/AQShunyi.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/AQShunyi.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/AQShunyi.sh
