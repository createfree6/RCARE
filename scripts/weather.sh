...
# Clean RCARE-Forecast launcher for weather.
# Usage examples:
#   bash scripts/weather.sh
#   RUN_STAGE=numeric bash scripts/weather.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/weather.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/weather.sh
