...
# Clean RCARE-Forecast launcher for Wind.
# Usage examples:
#   bash scripts/Wind.sh
#   RUN_STAGE=numeric bash scripts/Wind.sh
#   RUN_STAGE=full PRED_LENS="96 192" RATIOS="0.10" bash scripts/Wind.sh
#   NUMERIC_CKPT="checkpoints/<numeric-setting>/checkpoint.pth" bash scripts/Wind.sh
